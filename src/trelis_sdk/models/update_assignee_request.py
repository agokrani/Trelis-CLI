...
T = TypeVar("T", bound="UpdateAssigneeRequest")


@_attrs_define
class UpdateAssigneeRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_assignee_request = cls(
            assigned_to=assigned_to,
        )

        update_assignee_request.additional_properties = d
        return update_assignee_request
