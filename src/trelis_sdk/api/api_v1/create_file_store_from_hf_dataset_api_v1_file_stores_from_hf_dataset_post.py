...
from ...models.fetch_hf_dataset_request import FetchHFDatasetRequest
...
def _get_kwargs(
    *,
    body: FetchHFDatasetRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/file-stores/from-hf-dataset",
    }
...
def sync_detailed(
    *,
    ...
    `POST /file-stores/{id}/process` once the fetch job completes.

    Poll `GET /api/v1/data-prep/jobs/{job_id}` for progress.

    Args:
        body (FetchHFDatasetRequest): Request to load a HuggingFace dataset to the upload volume.
